...
export const testAccounts: TestAccount[] = [
  // 1. ORGANIZATÖR HESABI
  {
    ...
    profile: {
      ...
      bio: 'Türkiye\'nin önde gelen etkinlik organizasyon şirketlerinden Event Masters Turkey\'nin kurucusu. Festival, konser ve kurumsal etkinlik organizasyonunda 15 yıllık deneyim.',
    },
  },
  ...
  booking: [
    {
      ...
      venue: 'Çırağan Palace Kempinski',
      organizerName: 'Ahmet Yıldırım',
      organizerCompany: 'Event Masters Turkey',
