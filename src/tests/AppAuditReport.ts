...
export const detailedFindings: TestResult[] = [
  ...
  },
  {
    ...
    severity: 'medium',
    type: 'missing',
    description: 'Bildirim sistemi tam implemente değil',
    location: 'NotificationsScreen.tsx',
    suggestion: 'Push notification entegrasyonu ve bildirim tipleri',
    status: 'open',
  },
  {
    category: 'Data',
  ...
  },
  {
    ...
    severity: 'low',
    type: 'inconsistency',
    description: 'Bazı yerlerde any type kullanılmış',
    location: 'Multiple files',
    suggestion: 'Proper typing yapılmalı',
    status: 'open',
  },
  {
    category: 'Feature',
