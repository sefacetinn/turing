    ...
    if (isBookingCategory) {
      ...
      return bookingProviders
        ...
        return {
          ...
          image: bp.photoURL || bp.userPhotoURL || 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400',
      ...
      return bookingProviders
        ...
        .map((bp: FirestoreBookingProvider): Provider => {
          ...
          return {
            ...
            city: bp.city || 'İstanbul',
            teamSize: bp.employeeCount || '1-10',
            image: bp.photoURL || bp.userPhotoURL || 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=400',
            previouslyWorked: false,
            phone: bp.phone || '',
            verified: bp.isVerified,
            yearsExperience: yearsExp,
...
const styles = StyleSheet.create({
  ...
  filterButtonActive: { backgroundColor: 'rgba(75, 48, 184, 0.1)' },
  ...
  selectionButtonActive: { backgroundColor: 'rgba(75, 48, 184, 0.1)' },
  ...
  providerCardSelected: { borderColor: colors.brand[400], backgroundColor: 'rgba(75, 48, 184, 0.05)' },
  ...
  filterChipActive: { backgroundColor: 'rgba(75, 48, 184, 0.15)', borderColor: colors.brand[400] },
