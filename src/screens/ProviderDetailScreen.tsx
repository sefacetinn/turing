...
export function ProviderDetailScreen() {
  ...
  const profileImage = provider.photoURL || provider.userPhotoURL || 'https://ui-avatars.com/api/?name=' + encodeURIComponent(displayName) + '&background=6366F1&color=fff&size=200';
